...
# Read a type.
# Always return a type. If type in file can not be matched, a new type is
# evaled into JLD2.ReconstructedTypes.
...
# Generate a ReadRepresentation for reading datatypes
